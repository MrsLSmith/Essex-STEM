...
class Actions extends React.Component {
    ...
    setTitle = () => {
        this.props.navigator.setTitle({title: 'New Title!'});
    };
    toggleTabs = () => {
        const to = this._toggleTabs === 'shown'
            ? 'hidden'
            : 'shown';
    ...
    toggleNavBar = () => {
        const to = this._toggleNavBar === 'shown'
            ? 'hidden'
            : 'shown';
        this.props.navigator.toggleNavBar({to, animated: true});
        this._toggleNavBar = to;
    };
    showSnackbar = () => {
        this.props.navigator.showSnackbar({title: 'Woo Snacks!'});
    };
    ...
    toggleFAB = () => {
        if (this._fab) {
            this.props.navigator.setButtons({fab: {}});
            this._fab = false;
        } else {
            this.props.navigator.setButtons({
                fab: {
