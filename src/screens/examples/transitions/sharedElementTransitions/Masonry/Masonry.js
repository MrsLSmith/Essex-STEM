        ...
        return (
            <TouchableHighlight key={key} onPress={() => {
                ...
                <View style={{
                    ...
                    <SharedElementTransition style={{
                        flex: 1
                    }} sharedElementId={key}>
                        <Image source={asset.source} resizeMode={'cover'} style={styles.asset}/>
        ...
        return (
            <View style={[
                ...
                {[...new Array(COLS)].map((column, columnIndex) => (
                    <View key={`row_${index}_column_${columnIndex}`} style={{
                        flex: 1
                    }}>
    ...
    render() {
        return (
            <View style={styles.container}>
                <FlatList data={images} renderItem={this.renderItem} getItemLayout={(layout, index) => ({
                    length: ROW_HEIGHT,
