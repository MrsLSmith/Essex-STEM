...
class Types extends React.Component {
    ...
    pushScreen = () => {
        this.props.navigator.push({screen: 'GreenUpVermont.Types.Push', title: 'New Screen'});
    };
    pushTopTabsScreen = () => {
    ...
    showModal = () => {
        this.props.navigator.showModal({screen: 'GreenUpVermont.Types.Modal', title: 'Modal'});
    };
    showLightBox = () => {
    ...
    showInAppNotification = () => {
        this.props.navigator.showInAppNotification({screen: 'GreenUpVermont.Types.Notification'});
    };
    render() {
        return (
