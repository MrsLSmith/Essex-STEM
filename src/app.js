...
Navigation.startSingleScreenApp({
    screen: {
        screen: 'GreenUpVermont.Welcome', // unique ID registered with Navigation.registerScreen
    ...
    drawer: { // optional, add this if you want a side menu drawer in your app
        right: { // optional, define if you want a drawer from the left
            screen: 'GreenUpVermont.Types.Drawer', // unique ID registered with Navigation.registerScreen
