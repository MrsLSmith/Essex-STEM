...
class TrashToggles extends Component {
    ...
    render() {
        return ( <
            ...
            <
            View style = {
                [styles.buttonBarHeader, { backgroundColor: '#EEE', marginTop: 30 }] } >
            <
            ...
            <
            View style = {
                [styles.infoBlockContainer, { height: 300 }] } >
            <
            ...
            onValueChange = {
                () => this.props.actions.toggleTrashData('myTrashToggle', !this.props.myTrashToggle) }
            /> <
            Toggle style = { styles.toggle }
            icon = { circleRed }
            ...
            onValueChange = {
                () => this.props.actions.toggleTrashData('uncollectedTrashToggle', !this.props.uncollectedTrashToggle) }
            /> <
            Toggle style = { styles.toggle }
            icon = { circleBlue }
            label = 'Trash Drop-Offss'
            value = { this.props.trashDropOffToggle }
            onValueChange = {
                () => this.props.actions.toggleTrashData('trashDropOffToggle', !this.props.trashDropOffToggle) }
            /> <
            Toggle style = { styles.toggle }
            icon = { circleGreen }
            ...
            onValueChange = {
                () => this.props.actions.toggleTrashData('supplyPickupToggle', !this.props.supplyPickupToggle) }
            /> <
            Toggle style = { styles.toggle }
            icon = { circleGray }
            ...
            onValueChange = {
                () => this.props.actions.toggleTrashData('collectedTrashToggle', !this.props.collectedTrashToggle) }
            /> <
            /View> <
            /View>
        );
